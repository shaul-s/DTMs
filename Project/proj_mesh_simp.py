...
if __name__ == '__main__':
    ...
    ax6.hist(heights_diff_Vremoval, 50, facecolor='b')
    # ax6.hist(heights_diff_Vremoval, density=True, facecolor='b')
    ...
    ax7.hist(heights_diff_Tremoval, 50, facecolor='b')
    ...
    ax8.hist(heights_diff_Tcontraction, 50, facecolor='b')
    ...
    ax9.hist(heights_diff_Econtraction, 50, facecolor='b')
